...
int Rates(double *y, double *rate, double *k, int *ipar, InputStructure *Input)
{
   ...
   rate[32] = k_jim(100000000.0, 121394, 0) * y[ADIOM2] * y[RPHENOXM2];
   rate[33] = k_jim(100000000.0, 121394, 0) * y[KETM2] * y[RPHENOXM2];
   rate[34] = k_jim(100000000.0, 121394, 0) * y[RPHENOXM2] * y[KETDM2];
   rate[35] = k_jim(100000000.0, 121394, 0) * y[SYNAPYL] * y[RPHENOXM2];
   rate[36] = k_jim(100000000.0, 121394, 0) * y[ADIOM2] * y[RPHENOX];
   rate[37] = k_jim(100000000.0, 121394, 0) * y[KETM2] * y[RPHENOX];
   rate[38] = k_jim(100000000.0, 121394, 0) * y[RPHENOX] * y[KETDM2];
   rate[39] = k_jim(100000000.0, 121394, 0) * y[SYNAPYL] * y[RPHENOX];
   rate[40] = k_jim(100000000.0, 121394, 0) * y[ADIO] * y[RPHENOX];
   rate[41] = k_jim(100000000.0, 121394, 0) * y[KET] * y[RPHENOX];
   rate[42] = k_jim(100000000.0, 121394, 0) * y[KETD] * y[RPHENOX];
   rate[43] = k_jim(100000000.0, 121394, 0) * y[COUMARYL] * y[RPHENOX];
   rate[44] = k_jim(100000000.0, 121394, 0) * y[ADIO] * y[RPHENOXM2];
   rate[45] = k_jim(100000000.0, 121394, 0) * y[KET] * y[RPHENOXM2];
   rate[46] = k_jim(100000000.0, 121394, 0) * y[KETD] * y[RPHENOXM2];
   rate[47] = k_jim(100000000.0, 121394, 0) * y[COUMARYL] * y[RPHENOXM2];
   rate[48] = k_jim(100000000.0, 115115, 0) * y[C10H2M4] * y[RPHENOXM2];
   rate[49] = k_jim(100000000.0, 115115, 0) * y[C10H2M2] * y[RPHENOXM2];
   rate[50] = k_jim(100000000.0, 117208, 0) * y[C10H2M4] * y[RPHENOX];
   rate[51] = k_jim(100000000.0, 117208, 0) * y[C10H2M2] * y[RPHENOX];
